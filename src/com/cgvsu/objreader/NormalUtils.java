...
public class NormalUtils {
    ...
    public static ArrayList<float[]> calculateNormalsInArray(Model model) {
        ...
        for (Vector3f wordsInLine : model.getVertices()) {
            ...
            vector[0] = (wordsInLine.getX());
            vector[1] = (wordsInLine.getY());
            vector[2] = (wordsInLine.getZ());
            vectors.add(vector);
        }
    ...
    protected static float[] findNormalFace(float arr[][]) {
        ...
        normal = normalForVectors.find(vector1, vector2);
        ...
        while (size != vector.length) {
            ...
            size++;
            normal = normalForVectors.find(normal, vectorSize);
        }
    ...
    public static void print(Model model) {
        ...
        for (Vector3f current: normal) {
            System.out.print("vn " + current.getX() + " " + current.getY() + " " + current.getZ());
            System.out.println();
        }
    }
}
